...
/* 
uint Qoff =3; // debug with Stvens impl.


void find_block0SI(uint32 block[], const uint32 IV[])
{
	...
	{
		Q[Qoff + 1] = randX();
		Q[Qoff + 3] = (randX() & 0xfe87bc3f) | 0x017841c0;
		Q[Qoff + 4] = (randX() & 0x44000033) | 0x000002c0 | (Q[Qoff + 3] & 0x0287bc00);
		Q[Qoff + 5] = 0x41ffffc8 | (Q[Qoff + 4] & 0x04000033);
		Q[Qoff + 6] = 0xb84b82d6;
		Q[Qoff + 7] = (randX() & 0x68000084) | 0x02401b43;
		Q[Qoff + 8] = (randX() & 0x2b8f6e04) | 0x005090d3 | (~Q[Qoff + 7] & 0x40000000);
		Q[Qoff + 9] = 0x20040068 | (Q[Qoff + 8] & 0x00020000) | (~Q[Qoff + 8] & 0x40000000);
		Q[Qoff + 10] = (randX() & 0x40000000) | 0x1040b089;
		Q[Qoff + 11] = (randX() & 0x10408008) | 0x0fbb7f16 | (~Q[Qoff + 10] & 0x40000000);
		Q[Qoff + 12] = (randX() & 0x1ed9df7f) | 0x00022080 | (~Q[Qoff + 11] & 0x40200000);
		Q[Qoff + 13] = (randX() & 0x5efb4f77) | 0x20049008;
		Q[Qoff + 14] = (randX() & 0x1fff5f77) | 0x0000a088 | (~Q[Qoff + 13] & 0x40000000);
		Q[Qoff + 15] = (randX() & 0x5efe7ff7) | 0x80008000 | (~Q[Qoff + 14] & 0x00010000);
		Q[Qoff + 16] = (randX() & 0x1ffdffff) | 0xa0000000 | (~Q[Qoff + 15] & 0x40020000);
		...
		while (counter < (1 << 7))
		{
			...
			uint32 q17 = ((randX () & 0x3ffd7ff7) | (q16&0xc0008008)) ^ 0x40000000;
			++counter;
